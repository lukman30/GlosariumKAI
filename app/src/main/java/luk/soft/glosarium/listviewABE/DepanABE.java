...
public class DepanABE extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.depanabe);
        getSupportActionBar().setElevation(0);

        mRecyclerview = (RecyclerView) findViewById(R.id.list);
        pd = new ProgressDialog(DepanABE.this);
        mItems = new ArrayList<>();



        mManager = new LinearLayoutManager(DepanABE.this, LinearLayoutManager.VERTICAL,false);
        mRecyclerview.setLayoutManager(mManager);
        mAdapter = new AdapterListabe(DepanABE.this,mItems);
    ...
    private void loadJson()
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET,
                Config.home+"/glosarium/list_abe.php?cari="+temp,null,
