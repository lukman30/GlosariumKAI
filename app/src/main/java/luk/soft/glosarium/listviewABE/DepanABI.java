...
public class DepanABI extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.depanabi);
        getSupportActionBar().setElevation(0);

        mRecyclerview = (RecyclerView) findViewById(R.id.list);
        pd = new ProgressDialog(DepanABI.this);
        mItems = new ArrayList<>();



        mManager = new LinearLayoutManager(DepanABI.this, LinearLayoutManager.VERTICAL,false);
        mRecyclerview.setLayoutManager(mManager);
        mAdapter = new AdapterListABI(DepanABI.this,mItems);
    ...
    private void loadJson()
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET,
                Config.home+"/glosarium/list_abi.php?cari="+temp,null,
