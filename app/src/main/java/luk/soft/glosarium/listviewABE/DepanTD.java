...
public class DepanTD extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.depantd);
        getSupportActionBar().setElevation(0);

        mRecyclerview = (RecyclerView) findViewById(R.id.list);
        pd = new ProgressDialog(DepanTD.this);
        mItems = new ArrayList<>();



        mManager = new LinearLayoutManager(DepanTD.this, LinearLayoutManager.VERTICAL,false);
        mRecyclerview.setLayoutManager(mManager);
        mAdapter = new AdapterListTD(DepanTD.this,mItems);
    ...
    private void loadJson()
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET,
                Config.home+"/glosarium/list_td.php?cari="+temp,null,
