...
public class DepanTP extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.depantp);
        getSupportActionBar().setElevation(0);

        mRecyclerview = (RecyclerView) findViewById(R.id.list);
        pd = new ProgressDialog(DepanTP.this);
        mItems = new ArrayList<>();



        mManager = new LinearLayoutManager(DepanTP.this, LinearLayoutManager.VERTICAL,false);
        mRecyclerview.setLayoutManager(mManager);
        mAdapter = new AdapterListTP(DepanTP.this,mItems);
    ...
    private void loadJson()
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET,
                Config.home+"/glosarium/list_tp.php?cari="+temp,null,
