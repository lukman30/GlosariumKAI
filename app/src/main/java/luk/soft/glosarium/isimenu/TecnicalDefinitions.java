...
import luk.soft.glosarium.adaptertecnical.SuggestionAdapterTecnical;
...
public class TecnicalDefinitions extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acTextView.setAdapter(new SuggestionAdapterTecnical(this,acTextView.getText().toString()));
    ...
    private void Tampilisi() {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET,
                Config.home+"/glosarium/tecnicallist.php?cari="+ambil, null,
