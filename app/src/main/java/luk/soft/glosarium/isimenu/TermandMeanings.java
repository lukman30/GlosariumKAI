...
public class TermandMeanings extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acTextView.setAdapter(new SuggestionAdapterTM(this,acTextView.getText().toString()));
    ...
    private void Tampilisi() {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET,
                Config.home+"/glosarium/termmeaninglist.php?cari="+ambil, null,
