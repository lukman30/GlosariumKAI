...
public class AcronymandAbbreviationEnglish extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.abenglish);
...
//        String temp=acTextView.getText().toString().replace(" ", "%20");
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, Config.home+"/glosarium/abelist.php?cari="+temp, null,
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                JSONObject data = response.getJSONObject(i);
                                        ...
                                        ambilmeaning.setText( data.getString("meaning"));
                                        ambilterms.setText( data.getString("terms"));
